...
/**
 * It's the unit of math.
 * Here are all units stored related to this subject and it's part
 ...
 * @since Apr/20/09
 */
public class Math implements WeightAndMeasurement
{
	/**
	 * current selected math measurement
	 */
	private String name = null;
	
	/**
	 * holds the elements of this type of unit class.
	 */
	private List<String> type = null;
	
	/**
	 * used to track easily the last selected element.
	 */
	private int selected = 0;
	
	/**
	 * here are the observers for this type of unit: <i>Math</i>
	 */
