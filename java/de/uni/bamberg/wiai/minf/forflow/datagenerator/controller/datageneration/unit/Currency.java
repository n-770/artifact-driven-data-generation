...
/**
 * This is the unit of currency.
 * Currency is the prevalent money accepted for exchange of goods in an economy.
 * This class is part of Weight and Measurements.
 * 
 * @author Michael Munz
 * @version 0.1
 * @since Apr/20/09
 */
public class Currency implements WeightAndMeasurement
{
	/**
	 * names the currency
	 */
	...
	/**
	 * holds the different types of currencies.
	 */
	private List<String> types = null;
	
	/**
	 * tracks the last selected
	 */
	private int selected = 0;
	
	/**
	 * here are the observers to <i>Currency</i>
	 */
	private List<ObserverUnit> observerUnit = null;
	
	/**
	 * default constructor.
	 * Names itself after class name
	 */
	public Currency()
	{
